            ...
            <el-card class="search-card">
                <el-form :inline="true" :model="searchModel" class="search-form-inline">
                    <el-form-item label="名称">
                        <el-input v-model="searchModel.areaName" placeholder="名称" clearable></el-input>
                    </el-form-item>
                    <el-form-item label="简称">
                        <el-input v-model="searchModel.abbreviation" placeholder="简称" clearable></el-input>
                    </el-form-item>
                    <el-form-item>
            ...
            <el-main>
                ...
                <el-card class="table-card">
                    <el-table :data="datas"
                        ...
                        <el-table-column fixed prop="areaName" label="地区名称" show-overflow-tooltip width="180">
                            <template slot-scope="scope">
                                <el-button type="text" size="small" @click="getListById(scope.row)">{{ scope.row.areaName }}</el-button>
                            </template>
                        </el-table-column>
                        <el-table-column prop="abbreviation" label="地区简称"></el-table-column>
                ...
                <el-row :gutter="20">
                    <el-col :span="12">
                        <el-form-item label="地区名称" prop="areaName">
                            <el-input placeholder="名称" v-model="entityModel.areaName" autocomplete="off" clearable></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="地区简称" prop="abbreviation">
                            <el-input placeholder="简称" :disabled="inputIsDisabled" v-model="entityModel.abbreviation" autocomplete="off" clearable></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
...
<script>
    ...
    import { areaUrl } from "@/js/common/api.js";
    export default {
        name: 'AreaTemplate',
        data() {
            return {
        ...
        methods: {
            ...
            add() {
                ...
                this.entityModel.areaName = '';
                this.entityModel.abbreviation = '';
            ...
            sava(formName) {
                ...
                if (this.entityModel.id === 0) {
                    //添加
                    apiUrl = areaUrl.addInfo;
                    requestMethod = 'post';
                } else {
                    //修改
                    apiUrl = areaUrl.modInfo;
                    requestMethod = 'put';
                }
                //验证表单
            ...
            getPage() {
                ...
                var searchData = {
                    ...
                    areaName: this.searchModel.areaName,
                    abbreviation: this.searchModel.abbreviation
                };
                _this.$axios({
                    method: 'post',
                    url: areaUrl.getPage,
            ...
            onLinkObjectData(parentId) {
                ...
                this.searchModel.areaName = "";
                this.searchModel.abbreviation = "";
                this.getPage();
                this.getPath();
            },
            //点击树节点执行
