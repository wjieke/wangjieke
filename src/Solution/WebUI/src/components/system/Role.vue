            ...
            <el-card class="search-card">
                <el-form :inline="true" :model="searchModel" class="search-form-inline">
                    <el-form-item label="关键字">
                        <el-input v-model="searchModel.roleName" placeholder="名称" clearable></el-input>
                    </el-form-item>
            ...
            <el-main>
                ...
                <el-card class="table-card">
                    <el-table :data="datas"
                        ...
                        <el-table-column prop="id" label="角色编号" width="120" sortable></el-table-column>
                        <el-table-column prop="roleName" label="角色名称" show-overflow-tooltip width="">
                            <template slot-scope="scope">
                                <el-button type="text" size="small" @click="getListById(scope.row)">{{ scope.row.roleName }}</el-button>
                            </template>
                        </el-table-column>
                ...
                <el-row :gutter="0" type="flex" justify="center">
                    <el-col :span="12">
                        <el-form-item label="角色名称" prop="roleName">
                            <el-input style="width:200px; float:left;" placeholder="名称" v-model="entityModel.roleName" autocomplete="off" clearable></el-input>
                        </el-form-item>
                    ...
                    <el-col :span="12" style="width:300px; height:368px;overflow:auto;">
...
<script>
    ...
    import { enumUrl, roleUrl, permissionUrl } from "@/js/common/api.js";
    export default {
        name: 'RoleTemplate',
        data() {
            return {
        ...
        methods: {
            ...
            save(formName) {
                ...
                if (this.entityModel.id === 0) {
                    //添加
                    apiUrl = roleUrl.addInfo;
                    requestMethod = 'post';
                } else {
                    //修改
                    apiUrl = roleUrl.modInfo;
                    requestMethod = 'put';
                }

                var checkedNodes = this.$refs.tree.getCheckedNodes();
                var permissionIds = checkedNodes.map(o => o.permissionId);
                this.entityModel.permissionIds = permissionIds;
            ...
            getPage() {
                ...
                var searchData = {
                    ...
                    roleName: this.searchModel.roleName
                };
                _this.$axios({
                    method: 'post',
                    url: roleUrl.getPage,
